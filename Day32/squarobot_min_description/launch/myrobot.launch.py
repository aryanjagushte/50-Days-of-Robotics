...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='squarobot_min_description').find('squarobot_min_description')
    default_model_path = os.path.join(pkg_share, 'urdf/squarobot_min.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'config/display.rviz')
    #world_path=os.path.join(pkg_share, 'worlds','miniworld.sdf'),
    ...
    arguments=['-entity', 'squarobot_min', '-topic', 'robot_description'],
    parameters= [{'use_sim_time': use_sim_time}],
    output='screen'
    )
